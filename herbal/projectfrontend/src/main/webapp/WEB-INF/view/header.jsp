...
<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/logo pucca.jpg'></c:url>" alt="AYURVEDIC & HERBAL PRODUCTS" height="30px" width="60px"></a>
...
<li><a href="<c:url value='/all/getallproducts'></c:url>">Browse all products</a></li>
  <li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<li><a href="#">Herbal BeautyProducts</a><li>
				<li><a href="#">Ayurvedic soaps</a></li>
				<li><a href="#">Ayurvedic weightloss</a></li>
				<li><a href="#">Herbal Tooth Paste</a><li>
	</ul>
</li>
